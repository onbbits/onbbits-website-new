...
import ConnectVdo from './Videos/connect-api.mp4';
import AutomationVdo from './Videos/templates.mp4';
import ConversationVdo from './Videos/close-conversation.mp4';
import AnalyticsVdo from './Videos/analytics.mp4';

import whyIcon1 from './Images/smart-inbox.png';
import whyIcon2 from './Images/human-automation.png';
import whyIcon3 from './Images/conversion-first.png';
import whyIcon4 from './Images/actionable-insights.png';

import sureshImg from './Images/suresh.webp';
import arpitImg from './Images/arpit.webp';
import nirvishaImg from './Images/nirvisha.webp';
import krishnaImg from './Images/krishna.webp';
import priteshImg from './Images/pritesh.webp';
import sumitImg from './Images/sumit.webp';
import satyamImg from './Images/satyam.webp';

import sol1 from './Images/solution-1.webp';
import sol2 from './Images/solution-2.webp';
import sol3 from './Images/solution-3.webp';
import sol4 from './Images/solution-4.webp';
import sol5 from './Images/solution-5.webp';
import sol6 from './Images/solution-6.webp';
import sol8 from './Images/solution-8.webp';
import sol9 from './Images/solution-9.webp';
import sol10 from './Images/solution-10.webp';
...
import localServiceIcon from './Images/local-service.png';
import retailIcon from './Images/retail.png';
import WholesaleIcon from './Images/wholesale.png';
import { FiMail } from 'react-icons/fi';

import featureImg1 from './Images/bulk-broadcasting-feature.webp';
import featureImg3 from './Images/inbox-card.webp';
import featureImg4 from './Images/card-analytics.webp';
...
export const features = [
  {
    ...
    desc: "Automation designed to feel natural, personal, and customer-friendly at every interaction."
  },
  {
    title: "Simple setup",
    desc: "Get started in minutes with an intuitive, no-code setup and smooth onboarding experience."
  },
  {
    title: "Flexible pricing including free plan",
    desc: "Affordable, flexible pricing plans—including a free option—to support businesses at every stage."
  },
  {
    title: "Built to scale gradually",
    desc: "Start small and scale gradually with a platform designed to grow alongside your business needs."
  }
];
...
export const plans = [
  ...
  },
  {
    ...
    price: "₹799",
    period: "/month",
    note: "Additional 18% GST will be applicable.",
    features: [
      "All Features of Free Forever",
      "1 Owner, 3 Free Agents",
      "Create up to 10 Templates",
      "50 Conversation Tags",
      "Upto 1 GB of Asset Storage",
      "Upto 10 Custom Attributes",
      "1 Chat-bot Flow Included",
      "Multi Agent Access",
      "Run Broadcasts Seamlessly",
      "Inbox for Team Collaboration",
      "Plan & Automate Campaigns",
      "Analytics & Conversion Insights",
      "CSV Campaign Scheduler",
      "Priority Ticket-based Assistance",
      "Seamless API Access",
  ...
  },
  {
    ...
    features: [
      ...
      "1 Owner, 20 Free Agents",
      "Create upto 200 Templates",
      "200 Conversation Tags",
      "Upto 5 GB of Asset Storage",
      "30 Custom Attributes",
      "5 Chat-bot Flow Available",
...
export const featuresPgData=[
  {
    ...
    points:[
      ...
      "Track delivery, clicks, and replies in real-time.",
  ...
  },
  {
    ...
    points:[
      ...
      "Send timely, personalized messages that convert.",
  ...
  },
   {
    ...
    points:[
      ...
      "Download reports or schedule them via email.",
    ...
    points:[
      ...
      "Add notes and assign owners for better follow-up.",
    ...
    points:[
      ...
      "Hand over to human agent smoothly when needed.",
      "Reduce support load while improving experience."
    ]
  }
]
