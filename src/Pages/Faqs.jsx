...
import { APIFaqs, gettingStartedFaqs, pricingPlansFaqs, productFeaturesFaqs, securityComplianceFaqs, supportAccountFaqs, templateAutomationFaqs } from "../Data";
        ...
        <div className="faq-wrapper">
          ...
          <div className="faq-categories">
            {categories.map((cat, index) => (
              <button
                key={index}
                className={`faq-category ${activeCategory.label === cat.label ? "active" : ""
                  }`}
                onClick={() => {
